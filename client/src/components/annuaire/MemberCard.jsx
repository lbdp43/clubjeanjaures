    ...
    >
      ...
      {(member.phone || email) && (
        <div className="flex flex-wrap gap-2 pt-3 border-t border-gray-100">
          ...
          <button onClick={handleShare} className="p-2.5 rounded-xl border border-gray-200 hover:border-blue text-text-muted hover:text-blue transition-colors" aria-label="Partager">
