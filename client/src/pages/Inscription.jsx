      ...
      <div className="card max-w-md w-full p-5 sm:p-8 fade-in">
        ...
        {mode === 'password' && (
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              <label htmlFor="email-reg" className="block text-sm font-medium mb-2">Adresse email professionnelle</label>
              <input id="email-reg" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="input-field" placeholder="votre@entreprise.fr" required autoFocus />
            </div>
            <div>
